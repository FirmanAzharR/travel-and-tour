<section id="carter-bus" class="contact section light-background">
    ...
    <div class="container section-title" data-aos="fade-up">
        ...
        <p>Jadikan perjalanan Anda lebih berkesan dengan layanan sewa kendaraan terpercaya. Kenyamanan dan keamanan
                    ...
                    <form id="carter-bus-form" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="wa_number" class="form-control" name="wa_number"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" id="total_passengers" class="form-control" name="total_passengers"
                                    placeholder="Total Passengers" required data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Total Passengers">
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" id="booking_date_start" class="form-control"
                                    name="booking_date_start" required>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" id="booking_date_end" class="form-control" name="booking_date_end"
                                    required>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" id="pickup_address" class="form-control" name="pickup_address"
                                    placeholder="Alamat lengkap penjemputan" required>
                            </div>
                        ...
                        if (carterBusForm) {
                            carterBusForm.addEventListener('submit', function(e) {
                                ...
                                function ensureWhatsAppNumber(callback) {
                                    ...
                                    var contactApi =
                                        '<?= base_url('Content_Management/get_contact_data') ?>';
                                    fetch(contactApi, {
                                            method: 'GET',
                                            headers: {
                                        ...
                                        .then(function(res) {
                                            if (res && res.status === 'success' && res.data && res
                                                .data.whatsapp) {
                                                var wa = res.data.whatsapp.toString().trim()
                                                    .replace(/\s+/g, '');
                                        ...
                                        .then(data => {
                                            if (data.status === 'success') {
                                                Swal.fire({
                                                    ...
                                                    const returnDate = encodeURIComponent(
