<section id="rental-mobil" class="contact section rental-section">
    <div class="container section-title" data-aos="fade-up">
        ...
        <p>Nikmati kebebasan berwisata dengan armada kendaraan terawat, harga transparan, dan proses booking yang mudah
            untuk pengalaman liburan tanpa hambatan</p>
    </div>
                    ...
                    <form id="booking-rental-form" class="rental-form" data-aos="fade-up" data-aos-delay="200">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="car-name" id="car-name" class="form-control"
                                        placeholder="Klik untuk memilih mobil" readonly required>
                                    <span class="input-group-text" id="car-picker-btn"><i
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control" name="wa_number" id="wa-number"
                                    placeholder="Contoh: 628123456789" required>
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="booking-date-start"><i class="fas fa-calendar-alt me-2"></i>Tanggal Mulai
                                    Sewa</label>
                                <input type="date" class="form-control" name="booking_date_start"
                                    id="booking-date-start" required>
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="booking-date-end"><i class="fas fa-calendar-check me-2"></i>Tanggal Selesai
                                    Sewa</label>
                                <input type="date" class="form-control" name="booking_date_end" id="booking-date-end"
                                    required>
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="duration"><i class="fas fa-clock me-2"></i>Durasi Sewa</label>
                                <input type="text" class="form-control" name="duration" placeholder="Contoh: 3 hari"
                                    required data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Durasi sewa dalam hari">
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="pickup-address"><i class="fas fa-map-marker-alt me-2"></i>Alamat
                                    Penjemputan</label>
                                <input type="text" class="form-control" name="pickup-address"
                                    placeholder="Salin alamat dari Google Maps" required data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Alamat penjemputan">
                            </div>

                            <div class="col-md-4 form-group">
                                <label for="booking-type"><i class="fas fa-tag me-2"></i>Tipe Booking</label>
                                <select class="form-control" name="booking-type" required data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Tipe Booking">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <input type="text" class="form-control" name="rute-pemakaian"
                                    placeholder="Contoh: Dalam Kota / Luar Kota" required data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Rute Pemakaian">
                            </div>
    ...
    <div class="modal fade rental-modal" id="carPickerModal" tabindex="-1" aria-labelledby="carPickerModalLabel"
        aria-hidden="true">
                        ...
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary pilih-mobil-btn"
...
.rental-form .form-group:nth-child(4) {
...
.rental-form .form-group:nth-child(9) {
