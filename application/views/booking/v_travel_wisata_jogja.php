<section id="travel-wisata-jogja" class="travel-section">
  ...
  <div class="container section-title" data-aos="fade-up">
      ...
      <p>Jelajahi keindahan Yogyakarta dengan layanan travel terpercaya kami. Nikmati perjalanan yang nyaman dan berkesan bersama keluarga.</p>
          ...
          <div class="col-lg-12">
              <div class="booking-card" data-aos="fade-up" data-aos-delay="300">
                  <div class="booking-header">
                      ...
                      <p>Isi form di bawah ini untuk melakukan pemesanan travel wisata Jogja. Tim kami akan segera menghubungi Anda via WhatsApp.</p>
                  </div>
                      ...
                      <div class="form-grid">
                          <div class="form-group">
                              ...
                              <div class="input-wrapper">
                                  <input type="text" id="name" name="name" class="form-control modern-input" placeholder="Masukkan nama lengkap Anda" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-wrapper">
                                  <input type="tel" id="wa-number" class="form-control modern-input" name="wa-number" placeholder="08xxxxxxxxxx" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-wrapper">
                                  <input type="number" id="total-passenger" class="form-control modern-input" name="total-passenger" placeholder="Jumlah orang" min="1" required>
                              </div>
                          </div>

                          <div class="form-group">
                              <label for="tour-destination"><i class="fas fa-map-marker-alt"></i> Destinasi Wisata</label>
                              <div class="input-wrapper">
                                  <input type="text" id="tour-destination" class="form-control modern-input" name="tour-destination" placeholder="Contoh: Malioboro, Taman Sari, dll" required>
                              </div>
                          </div>

                          <div class="form-group">
                              <label for="booking-date"><i class="fas fa-calendar-alt"></i> Tanggal Keberangkatan</label>
                              <div class="input-wrapper">
                                  <input type="date" id="booking-date" class="form-control modern-input" name="booking-date" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-wrapper">
                                  <input type="time" id="pickup-time" class="form-control modern-input" name="pickup-time" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="input-wrapper">
                                  <input type="text" id="duration" class="form-control modern-input" name="duration" placeholder="Contoh: 1 hari, 2 hari 1 malam" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group full-width">
                              ...
                              <div class="input-wrapper">
                                  <input type="text" id="pickup-address" class="form-control modern-input" name="pickup-address" placeholder="Salin alamat lengkap dari Google Maps" required>
                              </div>
                          </div>
                      </div>
                          ...
                          Swal.fire({
                              ...
                              const generatePDF = () => {
                                  return new Promise((resolve) => {
                                      ...
                                      pdfForm.method = 'POST';
                                      pdfForm.action = '<?= base_url('booking/generate_pdf') ?>';
                              ...
                              generatePDF().then((pdfUrl) => {
                                  ...
                                  message += `Saya sudah melakukan pemesanan tiket wisata dengan detail sebagai berikut:%0A%0A`;
                                  ...
                                  if (pdfUrl) {
                                      ...
                                      message += `Silakan download tiket PDF di link berikut:%0A`;
                                      message += `${cleanPdfUrl}%0A%0A`;
                                      message += `Harap simpan tiket ini sampai transaksi berakhir.`;
                                  }
