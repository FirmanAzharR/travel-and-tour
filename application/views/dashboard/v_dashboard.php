...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-bottom-primary shadow h-100 py-2 clickable-card-dashboard"
                data-url="booking-travel-wisata">
                <div class="card-body">
        ...
        <!-- Travel Bandara Card -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-bottom-success shadow h-100 py-2 clickable-card-dashboard"
                data-url="booking-travel-bandara">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
        ...
        <!-- Rental Mobil Card -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-bottom-warning shadow h-100 py-2 clickable-card-dashboard"
                data-url="booking-rental-mobil">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
        ...
        <!-- Carter Bus Card -->
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-bottom-danger shadow h-100 py-2 clickable-card-dashboard"
                data-url="booking-carter-bus">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
