   ...
   <body id="page-top">
      ...
      <div id="wrapper">
         ...
         <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               <!-- Topbar -->
               <?php $this->load->view('dashboard/partials/topbar'); ?>
               <!-- End of Topbar -->
               <!-- Begin Page Content -->
      ...
      <script src="<?= base_url('sb-admin/') ?>js/demo/chart-bar-demo.js"></script>
      ...
      <script>
         $(function() {
                 ...
                 if (href && href !== '#' && !href.startsWith('javascript')) {
                     ...
                     $.get(href, function(data) {
                         ...
                         if (href.includes('dashboard')) {
                            ...
                            $.getScript("<?= base_url('sb-admin/js/demo/chart-bar-demo.js') ?>", function() {
                                renderBarChart();
                            });
                            $.getScript("<?= base_url('sb-admin/js/demo/chart-pie-demo.js') ?>", function() {
                                renderPieChart();
                            });
                        }
                     });
            ...
            $(document).on('mouseenter', '.clickable-card-master-data', function() {
             ...
             // Event delegation: Klik card load konten via AJAX
            // $(document).off('click', '.clickable-card').on('click', '.clickable-card', function() {
