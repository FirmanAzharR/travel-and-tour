            ...
            <div class="hero-image" data-aos="zoom-out" data-aos-delay="300">
              ...
              <div class="customers-badge">
                <div class="customer-avatars">
                  <img src="<?=base_url('landing-page/')?>assets/img/avatar-1.webp" alt="Customer 1" class="avatar">
                  <img src="<?=base_url('landing-page/')?>assets/img/avatar-2.webp" alt="Customer 2" class="avatar">
              ...
              <div class="row gy-4">
                <div class="col-lg-5">
                  <div class="profile d-flex align-items-center gap-3">
                    <img src="<?=base_url('landing-page/')?>assets/img/avatar-1.webp" alt="CEO Profile" class="profile-image">
                    <div>
          ...
          <div class="col-xl-6" data-aos="fade-up" data-aos-delay="300">
            <div class="image-wrapper">
              <div class="images position-relative" data-aos="zoom-out" data-aos-delay="400">
                <img src="<?=base_url('landing-page/')?>assets/img/about-5.webp" alt="Business Meeting" class="img-fluid main-image rounded-4">
                <img src="<?=base_url('landing-page/')?>assets/img/about-2.webp" alt="Team Discussion" class="img-fluid small-image rounded-4">
              </div>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="phone-mockup text-center">
              <img src="<?=base_url('landing-page/')?>assets/img/phone-app-screen.webp" alt="Phone Mockup" class="img-fluid">
            </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-1.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-2.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-3.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-4.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-5.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-6.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-7.png" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="<?=base_url('landing-page/')?>assets/img/clients/client-8.png" class="img-fluid" alt=""></div>
          </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="testimonial-item">
              <img src="<?=base_url('landing-page/')?>assets/img/testimonials/testimonials-1.jpg" class="testimonial-img" alt="">
              <h3>Saul Goodman</h3>
              <h4>Ceo &amp; Founder</h4>
              <div class="stars">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="testimonial-item">
              <img src="<?=base_url('landing-page/')?>assets/img/testimonials/testimonials-2.jpg" class="testimonial-img" alt="">
              <h3>Sara Wilsson</h3>
              <h4>Designer</h4>
              <div class="stars">
                <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="testimonial-item">
              <img src="<?=base_url('landing-page/')?>assets/img/testimonials/testimonials-3.jpg" class="testimonial-img" alt="">
              <h3>Jena Karlis</h3>
              <h4>Store Owner</h4>
              <div class="stars">
                <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="testimonial-item">
              <img src="<?=base_url('landing-page/')?>assets/img/testimonials/testimonials-4.jpg" class="testimonial-img" alt="">
              <h3>Matt Brandon</h3>
              <h4>Freelancer</h4>
              <div class="stars">
                <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i>
